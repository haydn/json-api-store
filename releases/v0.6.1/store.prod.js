...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}();require("array.prototype.find");var _rxLite=require("rx-lite"),_rxLite2=_interopRequireDefault(_rxLite),_ajaxAdapter=require("./ajax-adapter"),_ajaxAdapter2=_interopRequireDefault(_ajaxAdapter),Store=function(){function e(t){_classCallCheck(this,e),this._adapter=t,this._data={},this._subject=new _rxLite2["default"].Subject,this._subscriptions={},this._types={},this.observable=this._subject.asObservable()}return _createClass(e,null,[{key:"attr",value:function(t,r){return t&&"object"==typeof t?e.attr(null,t):{type:"attr","default":r&&r["default"],deserialize:function(e,r){return e.attributes&&e.attributes[t||r]},serialize:function(e,r,i){r.attributes[t||i]=e[i]}}}},{key:"hasOne",value:function(t,r){return t&&"object"==typeof t?e.hasOne(null,t):{type:"has-one",inverse:r&&r.inverse,deserialize:function(e,r){if(t=t||r,e.relationships&&e.relationships[t]){if(null===e.relationships[t].data)return null;if(e.relationships[t].data)return this.find(e.relationships[t].data.type,e.relationships[t].data.id)}},serialize:function(e,r,i){null===e[i]?r.relationships[t||i]=null:e[i]&&(r.relationships[t||i]={data:{type:e[i].type,id:e[i].id}})}}}},{key:"hasMany",value:function(t,r){return t&&"object"==typeof t?e.hasMany(null,t):{type:"has-many","default":[],inverse:r&&r.inverse,deserialize:function(e,r){var i=this;if(t=t||r,e.relationships&&e.relationships[t]){if(null===e.relationships[t].data)return[];if(e.relationships[t].data)return e.relationships[t].data.map(function(e){return i.find(e.type,e.id)})}},serialize:function(e,r,i){e[i]&&(r.relationships[t||i]={data:e[i].map(function(e){return{type:e.type,id:e.id}})})}}}}]),_createClass(e,[{key:"add",value:function(e){var t=this;if(!e)throw new TypeError("You must provide data to add");if(!e.type||!e.id)throw new TypeError("The data must have a type and id");!function(){var r=t._data[e.type]&&t._data[e.type][e.id]?"updated":"added",i=t.find(e.type,e.id),n=t._types[e.type];Object.keys(n).forEach(function(r){"_"!==r[0]&&t._addField(e,i,n,r)}),t._subject.onNext({name:r,type:e.type,id:e.id,resource:i})}()}},{key:"convert",value:function(e,t,r){var i=this;if(e&&"object"==typeof e)return this.convert(e.type,e.id,e);if(t&&"object"==typeof t)return this.convert(e,t.id,t);var n=function(){var n={type:e,attributes:{},relationships:{}};t&&(n.id=t);var a=i._types[n.type];return Object.keys(a).forEach(function(e){"_"!==e[0]&&a[e].serialize(r,n,e)}),{v:n}}();return"object"==typeof n?n.v:void 0}},{key:"create",value:function(e,t,r,i,n){if(!this._adapter)throw new Error("Adapter missing. Specify an adapter when creating the store: `var store = new Store(adapter);`");this._adapter.create(this,e,t,r,i,n)}},{key:"define",value:function(e,t){var r=this;if(e=e.constructor===Array?e:[e],!t)throw new Error("You must provide a definition for the type '"+e[0]+"'.");t._names=e,e.forEach(function(e){if(r._types[e])throw new Error("The type '"+e+"' has already been defined.");r._types[e]=t})}},{key:"destroy",value:function(e,t,r,i,n){if(!this._adapter)throw new Error("Adapter missing. Specify an adapter when creating the store: `var store = new Store(adapter);`");this._adapter.destroy(this,e,t,r,i,n)}},{key:"find",value:function(e,t){var r=this;if(!e)throw new TypeError("You must provide a type");var i=function(){var i=r._types[e];if(i)return r._data[e]||!function(){var e={};i._names.forEach(function(t){return r._data[t]=e})}(),t?(r._data[e][t]||(r._data[e][t]={_dependents:[],type:e,id:t},Object.keys(i).forEach(function(n){"_"!==n[0]&&(r._data[e][t][n]=i[n]["default"])})),{v:r._data[e][t]}):{v:Object.keys(r._data[e]).map(function(t){return r._data[e][t]})};throw new TypeError("Unknown type '"+e+"'")}();return"object"==typeof i?i.v:void 0}},{key:"load",value:function(e,t,r,i,n,a){if(!this._adapter)throw new Error("Adapter missing. Specify an adapter when creating the store: `var store = new Store(adapter);`");this._adapter.load(this,e,t,r,i,n,a)}},{key:"off",value:function(e,t,r,i){if(console.warn(["The `store.off()` method has been deprecated in favour of `store.observable`.","For more information see: https://github.com/haydn/json-api-store/releases/tag/v0.6.0"].join("\n")),"added"!==e&&"updated"!==e&&"removed"!==e)throw new Error("Unknown event '"+e+"'");if(!this._types[t])throw new Error("Unknown type '"+t+"'");r&&"[object Function]"==={}.toString.call(r)?this.off.call(this,e,t,null,r,i):this._subscriptions[e]&&this._subscriptions[e][t]&&this._subscriptions[e][t][r||"*"]&&(this._subscriptions[e][t][r||"*"].dispose(),delete this._subscriptions[e][t][r||"*"])}},{key:"on",value:function(e,t,r,i,n){var a=this;if(console.warn(["The `store.on()` method has been deprecated in favour of `store.observable`.","For more information see: https://github.com/haydn/json-api-store/releases/tag/v0.6.0"].join("\n")),"added"!==e&&"updated"!==e&&"removed"!==e)throw new Error("Unknown event '"+e+"'");if(!this._types[t])throw new Error("Unknown type '"+t+"'");if(r&&"[object Function]"==={}.toString.call(r))this.on.call(this,e,t,null,r,i);else if(!this._subscriptions[e]||!this._subscriptions[e][t]||!this._subscriptions[e][t][r||"*"]){var s=this._subject.filter(function(t){return t.name===e});s=s.filter(function(e){return-1!==a._types[t]._names.indexOf(e.type)}),r&&(s=s.filter(function(e){return e.id===r})),s=s.map(function(e){return a.find(e.type,e.id)}),this._subscriptions[e]=this._subscriptions[e]||{},this._subscriptions[e][t]||!function(){var r={};a._types[t]._names.forEach(function(t){a._subscriptions[e][t]=r})}(),this._subscriptions[e][t][r||"*"]=s.subscribe(i.bind(n))}}},{key:"push",value:function(e){var t=this;e.data.constructor===Array?e.data.forEach(function(e){return t.add(e)}):this.add(e.data),e.included&&e.included.forEach(function(e){return t.add(e)})}},{key:"remove",value:function(e,t){var r=this;if(!e)throw new TypeError("You must provide a type to remove");if(!this._types[e])throw new TypeError("Unknown type '"+e+"'");if(t){var i=this._data[e]&&this._data[e][t];i&&(this._remove(i),this._subject.onNext({name:"removed",type:e,id:t,resource:null}))}else Object.keys(this._data[e]).forEach(function(t){return r.remove(e,t)})}},{key:"update",value:function(e,t,r,i,n,a){if(!this._adapter)throw new Error("Adapter missing. Specify an adapter when creating the store: `var store = new Store(adapter);`");this._adapter.update(this,e,t,r,i,n,a)}},{key:"_addField",value:function(e,t,r,i){var n=this,a=r[i],s=a.deserialize.call(this,e,i);"undefined"!=typeof s&&("has-one"===a.type?(t[i]&&this._removeInverseRelationship(t,i,t[i],a),s&&this._addInverseRelationship(t,i,s,a)):"has-many"===a.type&&(t[i].forEach(function(e){-1!==t[i].indexOf(e)&&n._removeInverseRelationship(t,i,e,a)}),s.forEach(function(e){n._addInverseRelationship(t,i,e,a)})),t[i]=s)}},{key:"_addInverseRelationship",value:function(e,t,r,i){var n=this._types[r.type],a=this._types[e.type];if(n){var s=[i.inverse].concat(a._names).find(function(e){return n[e]}),o=n&&n[s];if(r._dependents.push({type:e.type,id:e.id,fieldName:t}),o){if("has-one"===o.type)e._dependents.push({type:r.type,id:r.id,fieldName:s}),r[s]=e;else if("has-many"===o.type)e._dependents.push({type:r.type,id:r.id,fieldName:s}),-1===r[s].indexOf(e)&&r[s].push(e);else if("attr"===o.type)throw new Error("The the inverse relationship for '"+t+"' is an attribute ('"+s+"')")}else if(i.inverse)throw new Error("The the inverse relationship for '"+t+"' is missing ('"+i.inverse+"')")}}},{key:"_remove",value:function(e){var t=this;e._dependents.forEach(function(r){var i=t._data[r.type][r.id];switch(t._types[r.type][r.fieldName].type){case"has-one":i[r.fieldName]=null;break;case"has-many":var n=i[r.fieldName].indexOf(e);-1!==n&&i[r.fieldName].splice(n,1)}i._dependents=i._dependents.filter(function(t){return!(t.type===e.type&&t.id===e.id)})}),delete this._data[e.type][e.id]}},{key:"_removeInverseRelationship",value:function(e,t,r,i){var n=this._types[r.type],a=i.inverse||e.type,s=n&&n[a];if(r._dependents=r._dependents.filter(function(r){return!(r.type===e.type&&r.id===e.id&&r.fieldName===t)}),s){if("has-one"===s.type)e._dependents=e._dependents.filter(function(e){return!(e.type===r.type&&e.id===r.id&&e.fieldName===a)}),r[a]=null;else if("has-many"===s.type)e._dependents=e._dependents.filter(function(e){return!(e.type===r.type&&e.id===r.id&&e.fieldName===a)}),r[a]=r[a].filter(function(t){return t!==e});else if("attr"===s.type)throw new Error("The the inverse relationship for '"+t+"' is an attribute ('"+a+"')")}else if(i.inverse)throw new Error("The the inverse relationship for '"+t+"' is missing ('"+i.inverse+"')")}}]),e}();exports["default"]=Store,Store.AjaxAdapter=_ajaxAdapter2["default"],module.exports=exports["default"];
